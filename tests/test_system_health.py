...
class SystemHealthBackupTests(unittest.TestCase):
    ...
    def test_backup_idle_by_default(self, *_mocks):
    ...
    def test_backup_active_when_in_progress(self, *_mocks):
        snap = system_health_snapshot()
    ...
    def test_backup_unknown_when_gateway_unreachable(self, *_mocks):
        snap = system_health_snapshot()
    ...
    @patch("sm_telemetry_monitor.system_health.live_summary", return_value={"latest": {}})
    @patch("sm_telemetry_monitor.system_health.get_health", return_value=_healthy_gateway())
    def test_last_backup_from_manifest(self, *_mocks):
    ...
    def test_last_backup_prefers_health_field(self, *_mocks):
        snap = system_health_snapshot()
